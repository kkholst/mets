...
#>  [4] RcppArmadillo_15.4.0-1 Matrix_1.7-5           xfun_0.60             
#>  [7] lattice_0.22-9         splines_4.6.1          lava_1.9.3            
#> [10] knitr_1.51             parallel_4.6.1         mvtnorm_1.4-2         
#> [13] cli_3.6.6              parallelly_1.48.0      grid_4.6.1            
#> [16] future_1.70.0          compiler_4.6.1         globals_0.19.1        
#> [19] tools_4.6.1            listenv_1.0.0          future.apply_1.20.2   
#> [22] evaluate_1.0.5         Rcpp_1.1.2             otel_0.2.0            
#> [25] rlang_1.3.0
```
