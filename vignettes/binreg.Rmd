...
and can thus be used for describing both survival or competing risks data. 
...
used for other computations based on these parameters. 
...
\end{align*}
based on an IPCW adjusted estmating equation (EE) with response  $Y(t)=I(T \leq t, \epsilon=1 )$
\begin{align*}
