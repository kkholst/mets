...
motivated by a specific practical problem. The aim of our work is
provide such tools.

Bender et al. in a nice recent paper also discussed how to generate survival data based on 
the Cox model, and restricted attention to some of the many useful parametric survival models 
(weibull, exponential).
...
```{r}
data(sTRACE)
 coxs <-   phreg(Surv(time,status==9)~strata(chf,vf),data=sTRACE)
