...
<img src="figure/cooking-survival-data-unnamed-chunk-16-1.png" alt="Recurrent events: Ghosh-Lin and Cox model."  />
...
<img src="figure/cooking-survival-data-unnamed-chunk-17-1.png" alt="Recurrent events: stratified two-stage model."  />
...
<img src="figure/cooking-survival-data-unnamed-chunk-17-2.png" alt="Recurrent events: stratified two-stage model."  />
...
<img src="figure/cooking-survival-data-unnamed-chunk-18-1.png" alt="Recurrent events: frailty model simulations."  />
...
<img src="figure/cooking-survival-data-unnamed-chunk-18-2.png" alt="Recurrent events: frailty model simulations."  />
...
<img src="figure/cooking-survival-data-unnamed-chunk-18-3.png" alt="Recurrent events: frailty model simulations."  />
...
#> [1] timereg_2.0.7  survival_3.8-6 mets_1.3.13   
#> 
#> loaded via a namespace (and not attached):
#>  [1] cli_3.6.6              knitr_1.51             rlang_1.3.0           
#>  [4] xfun_0.60              otel_0.2.0             future.apply_1.20.2   
#>  [7] listenv_1.0.0          lava_1.9.3             stats4_4.6.1          
#> [10] grid_4.6.1             evaluate_1.0.5         yaml_2.3.12           
#> [13] mvtnorm_1.4-2          numDeriv_2016.8-1.1    compiler_4.6.1        
#> [16] codetools_0.2-20       Rcpp_1.1.2             ucminf_1.2.3          
#> [19] future_1.70.0          lattice_0.22-9         digest_0.6.39         
#> [22] parallelly_1.48.0      parallel_4.6.1         splines_4.6.1         
#> [25] Matrix_1.7-5           tools_4.6.1            RcppArmadillo_15.4.0-1
#> [28] globals_0.19.1
```
