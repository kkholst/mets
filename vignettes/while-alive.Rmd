...
The marks (or here weights) can be stochastic if we are counting hospital expenses, for example, and is 
vector on the data-frame. The marks for the event times (defined through the causes) will then be used. 

Here weighting death with weight 2 and otherwise counting the recurrent events as before (with weight 1)
