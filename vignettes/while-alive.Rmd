...
it can improve the finite sample properties to employ a transformation such as square or cube-root, and
thus consider 
\begin{align*}
...
mean of events per time-unit shows that those on the active treatment has fewer 
events per time-unit on average.
