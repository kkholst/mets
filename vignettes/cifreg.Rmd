...
influence functions for the baseline and the regression coeficients.  
...
$S(X)$  is a set of strata defined from $X$, then an ubiased estimating equation is given by 
\begin{align*}
...
phreg/coxph function (thus equvalent to ccA)
