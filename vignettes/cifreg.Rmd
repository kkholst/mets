...
#         [,1]      [,2]      [,3]      [,4]          [,5]          [,6]
# Z1 0.1041234 0.2463099 0.1041235 0.2463099 -5.067153e-08 -2.850970e-09
# Z2 0.1902561 0.4895381 0.1902562 0.4895381 -8.968781e-08 -6.109376e-09
}
```

Slightly slightly different probably due to convergence settings, because
we get same standard errors when evaluated at same coefficients.
...
#         [,1]      [,2]          [,3]
# Z1 0.1041235 0.1041235 -2.914335e-16
# Z2 0.1902562 0.1902562 -3.330669e-16
 cbind(diag(coxfg$var)^.5,fg0$se.coef,diag(coxfg$var)^.5-fg0$se.coef)
#           [,1]      [,2]          [,3]
# [1,] 0.2471530 0.2463099  0.0008430730
# [2,] 0.4893451 0.4895381 -0.0001930397
 cbind(diag(coxfg$var)^.5,fg0$se1.coef,diag(coxfg$var)^.5-fg0$se1.coef)
#           [,1]      [,2]          [,3]
# [1,] 0.2471530 0.2471530  2.775558e-17
# [2,] 0.4893451 0.4893451 -3.330669e-16
}
```
...
#             [,1]         [,2]
# Z1 -9.714451e-17 1.665335e-16
# Z2  8.826273e-15 2.109424e-15
```

the cmprsk gives almost the same (probably convergence settings)
...
#            [,1]          [,2]
# Z1 5.394172e-08 -3.326961e-09
# Z2 1.078650e-07 -6.884919e-09
}
```
...
```{r}
 fgcm <- cifreg(Event(time,status)~Z1+Z2,data=dats,cause=1,propodds=NULL,cens.model=~strata(Z1,Z2))
 summary(fgcm)
 summary(fg)
```
