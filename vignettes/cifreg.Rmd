...
for the baseline and the regression coeficients.  The function can thus be used for large data. 
...
In the case with administrative censoring  we can simply provide the risk-set for the Fine-Gray or logistic link cumulative incidence regression models. 
...
rc <- 0.9
###
dats <- mets:::simul.cifsRA(n,rho1,rho2,beta,depcens=0,bin=1,rc=rc,rate=c(3,7))
...
The Fine-Gray model can similarly be estimated using the modified risk-set and the phreg function
