...
#           [,1]        [,2]          [,3]
# Z1  0.06882199  0.06882199 -4.246603e-15
# Z2 -0.36807951 -0.36807951  2.908784e-14
 cbind(diag(coxfg$var)^.5,fg0$se.coef,diag(coxfg$var)^.5-fg0$se.coef)
#            [,1]       [,2]         [,3]
# [1,] 0.08196556 0.08184642 1.191361e-04
# [2,] 0.16611225 0.16606444 4.781467e-05
 cbind(diag(coxfg$var)^.5,fg0$se1.coef,diag(coxfg$var)^.5-fg0$se1.coef)
#            [,1]       [,2]          [,3]
# [1,] 0.08196556 0.08196556 -9.714451e-17
# [2,] 0.16611225 0.16611225  7.494005e-16
}
