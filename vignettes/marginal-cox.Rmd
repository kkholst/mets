...
A basic component of our modelling of multivariate survival data is that many models are
built around marginals on Cox form. The marginal Cox model can be fitted efficiently
...
<img src="figure/marginal-cox-unnamed-chunk-5-1.png" alt="Cumulative baseline hazard with robust standard errors."  />
...
<img src="figure/marginal-cox-unnamed-chunk-6-1.png" alt="Survival predictions with robust standard errors."  />
...
The p-value reflects whether the observed score process is consistent with
the model. 
...
<img src="figure/marginal-cox-unnamed-chunk-9-1.png" alt="Cumulative score process for goodness of fit."  />
...
so we will not recover $\beta = 0.3$ and the model will not be
a proportional Cox model; we would therefore also expect to reject "proportionality" with
