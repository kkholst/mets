...
and more appropriate for the twin analysis (see Figure \@ref(fig:scatter1) and \@ref(fig:scatter2)).
...
![Scatter plot of logarithmic BMI measurements in MZ twins](figure/quantitative-twin-scatter1-1.png)
...
![Scatter plot of logarithmic BMI measurements in DZ twins](figure/quantitative-twin-scatter2-1.png)
...
Next we examine the marginal distribution (GEE model with working independence):
...
![Marginal association between BMI and Age for males and females.](figure/quantitative-twin-marg1-1.png)
