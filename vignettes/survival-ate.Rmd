...
causal assumptions the standardization can still be a useful summary measure. 

First looking at the cumulative incidence via a Fine-Gray model for the two causes and making a plot of the 
...
takes less memory and is quicker (for large data, binregG).
