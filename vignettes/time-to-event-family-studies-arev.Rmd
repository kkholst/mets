...
variance at $`r fitco4$coef[2]`$ in contrast to the $DZ$ variance at $`r fitco4$coef[1]`$.

Now we look at the polygenic modelling for survival data, here applied to
the cause specific hazards. 

```{r, label=survival-polygenic}
