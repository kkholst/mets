...
fullVignette <- Sys.getenv("_R_FULL_VIGNETTE_") %in% c("1","TRUE") || length(list.files("save"))==0
saveobj <- function(obj, null_elements) {
  ...
  saveRDS(x, paste0("save/", obj, ".rds"), compress="xz")
}
...
fitco1 <- readRDS("save/fitco1.rds")
fitco2 <- readRDS("save/fitco2.rds")
fitco3 <- readRDS("save/fitco3.rds")
fitco4 <- readRDS("save/fitco4.rds")
fitace <- readRDS("save/fitace.rds")
fitde <- readRDS("save/fitde.rds")
cse <- readRDS("save/cse.rds")
slr <- readRDS("save/slr.rds")
outacem <- readRDS("save/outacem.rds")
b0 <- readRDS("save/b0.rds")
b1 <- readRDS("save/b1.rds")
b2 <- readRDS("save/b2.rds")
a1 <- readRDS("save/a1.rds")
h2 <- readRDS("save/h2.rds")
concMZ <- readRDS("save/concMZ.rds")
s_mz_country <- readRDS("save/s_mz_country.rds")
s_dz_country <- readRDS("save/s_dz_country.rds")
```
