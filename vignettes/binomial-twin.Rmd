...
One way of fitting this model is the ALR algorithm, the alternating 
logistic regression, and this has been described in several papers
...
We now demonstrate how the models can fitted jointly and with another
syntax, that of course just fits the marginal model and subsequently fits
