...
We start by computing the average treatement effects for the transplant periods (gp) to get started, and then consider 
...
of gp and dnr. We later return to  a more detailed explanantion of the setting with the key components being
