...
c2 <- binregATE(Event(time,cause)~gp+dnr+preauto+ttt24,kumar,cause=2,
	treat.model=gp~dnr+preauto+ttt24,time=60,cens.model=~strata(gp,dnr,ttt24))
summary(c2)
...
c3 <- logitATE(cause2~gp+dnr+preauto+ttt24,kumar,treat.model=gp~dnr+preauto+ttt24)
summary(c3)

## quite similar to binregATE
c2 <- logitATE(Event(time,cause)~gp+dnr+preauto+ttt24,kumar,cause=2,time=60,treat.model=gp~dnr+preauto+ttt24)
summary(c2)
...
c3id <- logitATE(cause2~gp+dnr+preauto+ttt24+cluster(id),kumar,treat.model=gp~dnr+preauto+ttt24)
summary(c3id)

c4id <- binregATE(Event(time,cause)~gp+dnr+preauto+ttt24+cluster(id),kumar,
	  cause=2,treat.model=gp~dnr+preauto+ttt24,time=60,
