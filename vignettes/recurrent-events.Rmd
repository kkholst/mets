...
```{r}
 ...
 out  <- recreg(Event(start,stop,statusG)~X1+X2+cluster(id),data=rr,cause=1,death.code=2,cens.code=0)
 outs <- recreg(Event(start,stop,statusG)~X1+X2+cluster(id),data=rr,cause=1,death.code=2,cens.code=0,cens.model=~strata(X1,X2))
