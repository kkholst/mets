...
with(recEFF14,cbind(times,muP,semuP,muPAt,semuPAt,semuPAt/semuP))
#>       times       muP     semuP     muPAt   semuPAt          
#>  [1,]   500 0.8744004 0.1059068 0.8666248 0.1054676 0.9958527
#>  [2,]  1000 1.2696069 0.1458220 1.2643326 0.1444954 0.9909029
#>  [3,]  1500 1.7921498 0.2291966 1.8063847 0.2218546 0.9679664
#>  [4,]  2000 2.1216192 0.3047378 2.1433057 0.2888680 0.9479231
#>  [5,]  2500 2.4775306 0.3934784 2.4921739 0.3607251 0.9167595
#>  [6,]  3000 2.7947412 0.5183678 2.6962163 0.4264555 0.8226889
#>  [7,]  3500 3.0289847 0.6033927 2.7724622 0.4558819 0.7555311
#>  [8,]  4000 3.3163659 0.7183096 2.8716341 0.4752402 0.6616091
#>  [9,]  4500 3.6229966 0.8415333 2.9362206 0.4519121 0.5370103
#> [10,]  5000 3.8810150 0.9255727 2.9716900 0.3831633 0.4139743
...
#> [1] lava_1.9.3         prodlim_2026.03.11 timereg_2.0.7      survival_3.8-6    
#> [5] mets_1.3.13       
#> 
#> loaded via a namespace (and not attached):
#>  [1] vctrs_0.7.3            cli_3.6.6              knitr_1.51            
#>  [4] rlang_1.3.0            xfun_0.60              KernSmooth_2.23-26    
#>  [7] otel_0.2.0             data.table_1.18.4      glue_1.8.1            
#> [10] future.apply_1.20.2    listenv_1.0.0          stats4_4.6.1          
#> [13] grid_4.6.1             evaluate_1.0.5         lifecycle_1.0.5       
#> [16] yaml_2.3.12            mvtnorm_1.4-2          numDeriv_2016.8-1.1   
#> [19] compiler_4.6.1         codetools_0.2-20       Rcpp_1.1.2            
#> [22] ucminf_1.2.3           future_1.70.0          lattice_0.22-9        
#> [25] digest_0.6.39          pillar_1.11.1          parallelly_1.48.0     
#> [28] parallel_4.6.1         Matrix_1.7-5           tools_4.6.1           
#> [31] RcppArmadillo_15.4.0-1 globals_0.19.1
```
