...
One consequence of the model structure is that the Kendall's can be computed for 
...
data (Nan et al., 2006), and this model was extended to competing
risks in Shih and Lu (2010). 
