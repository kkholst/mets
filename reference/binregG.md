...
#> ────────────────────────────────────────────────────────────
#>      Estimate Std.Err   2.5%  97.5%   P-value
#> pa     0.4058 0.02588 0.3551 0.4566 1.980e-55
#> pa.1   0.5120 0.03706 0.4393 0.5846 2.087e-43
#> pa.2   0.6169 0.05517 0.5087 0.7250 5.018e-29
#> ────────────────────────────────────────────────────────────
#> Null Hypothesis: 
#>   [pa] = 0
#>   [pa] = 0
#>   [pa] = 0 
#>  
#> chisq = 259.041, df = 3, p-value < 2.2e-16
#> 
#> Average Treatment effect: ratio (G-estimator) :
#> log-ratio: 
#>     Estimate    Std.Err      2.5%     97.5%      P-value
#> pa 0.4058378 0.02587772 0.3551184 0.4565572 1.979814e-55
#> pa 0.5119589 0.03705982 0.4393230 0.5845949 2.087097e-43
#> pa 0.6168573 0.05516719 0.5087316 0.7249830 5.017889e-29
#> ratio: 
#>    Estimate     2.5%    97.5%
#> pa 1.500559 1.426350 1.578630
#> pa 1.668557 1.551656 1.794264
#> pa 1.853095 1.663180 2.064696
#> 
```
