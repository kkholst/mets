...
- [`ClaytonOakes()`](http://kkholst.github.io/mets/reference/ClaytonOakes.md)
...
- [`TRACE`](http://kkholst.github.io/mets/reference/TRACE.md)
  [`sTRACE`](http://kkholst.github.io/mets/reference/TRACE.md)
  [`tTRACE`](http://kkholst.github.io/mets/reference/TRACE.md) : The
...
- [`blocksample()`](http://kkholst.github.io/mets/reference/blocksample.md)
  : Block sampling

- [`bmt`](http://kkholst.github.io/mets/reference/bmt.md) : The Bone
...
- [`dby()`](http://kkholst.github.io/mets/reference/dby.md) : Calculate
  summary statistics grouped by

- [`dcor()`](http://kkholst.github.io/mets/reference/dcor.md) : summary,
  tables, and correlations for data frames

- [`dcut()`](http://kkholst.github.io/mets/reference/dcut.md) : Cutting,
  sorting, rm (removing), rename for data frames

- [`dermalridges`](http://kkholst.github.io/mets/reference/dermalridges.md)
  : Dermal ridges data (families)

- [`dermalridgesMZ`](http://kkholst.github.io/mets/reference/dermalridgesMZ.md)
...
- [`dreg()`](http://kkholst.github.io/mets/reference/dreg.md) :
...
- [`dspline()`](http://kkholst.github.io/mets/reference/dspline.md) :
  Simple linear spline

- [`dtable()`](http://kkholst.github.io/mets/reference/dtable.md) :
...
- [`lifetable(`*`<matrix>`*`)`](http://kkholst.github.io/mets/reference/lifetable.matrix.md)
  [`lifetable(`*`<formula>`*`)`](http://kkholst.github.io/mets/reference/lifetable.matrix.md)
  : Life table
...
- [`medweight()`](http://kkholst.github.io/mets/reference/medweight.md)
  : Computes mediation weights

- [`melanoma`](http://kkholst.github.io/mets/reference/melanoma.md) :
  The Melanoma Survival Data

- [`mena`](http://kkholst.github.io/mets/reference/mena.md) : Menarche
  data set

- [`mets.options()`](http://kkholst.github.io/mets/reference/mets.options.md)
  :

  Set global options for `mets`

- [`migr`](http://kkholst.github.io/mets/reference/migr.md) : Migraine
  data
...
- [`plot_twin()`](http://kkholst.github.io/mets/reference/plot_twin.md)
...
- [`twinstut`](http://kkholst.github.io/mets/reference/twinstut.md) :
  Stutter data set
