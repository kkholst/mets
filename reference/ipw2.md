...
Internal function. Calculates Inverse Probability of Censoring and
Truncation Weights and adds them to a data.frame
...
- times:
  ...
  possible time argument for speciying a maximum value of time
  tau=max(times), to specify when things are considered censored or not.
...
- same.cens:
  ...
  For clustered data, should same censoring be assumed and same
  truncation (bivariate probability calculated as mininum of the
...
- pair.cweight:
  ...
  Name of weight variable in the new data.frame for right censorig of
  pairs

- pair.tweight:

  Name of weight variable in the new data.frame for left truncation of
  pairs

- pair.weight:

  Name of weight variable in the new data.frame for right censoring and
  left truncation of pairs

- cname:

  Name of weight variable in the new data.frame for right censoring of
  individuals
...
- weight.name:
  ...
  Name of weight variable in the new data.frame for right censoring and
  left truncation of individuals
