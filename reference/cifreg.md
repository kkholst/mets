...
#> tcell    -0.709596  0.331977  0.274926  0.0326
#> platelet -0.455390  0.236003  0.187918  0.0537
#> age       0.391202  0.098035  0.083671  0.0001
#> 
#> exp(coefficients):
#>          Estimate    2.5%  97.5%
#> tcell     0.49184 0.25659 0.9428
#> platelet  0.63420 0.39934 1.0072
#> age       1.47876 1.22025 1.7920
#> 
par(mfrow=c(1,2))
plot(or)
...
#> coefficients:
#>           Estimate      S.E.   dU^-1/2 P-value
#> tcell    -0.597022  0.270445  0.275787  0.0273
#> platelet -0.425691  0.180741  0.187723  0.0185
#> age       0.343806  0.080275  0.086287  0.0000
#> 
#> exp(coefficients):
#>          Estimate    2.5%  97.5%
#> tcell     0.55045 0.32398 0.9352
#> platelet  0.65332 0.45844 0.9310
#> age       1.41031 1.20499 1.6506
#> 
...
#> coefficients:
#>           Estimate      S.E.   dU^-1/2 P-value
#> platelet -0.424253  0.180832  0.187825   0.019
#> age       0.341992  0.079868  0.086288   0.000
#> 
#> exp(coefficients):
#>          Estimate    2.5%  97.5%
#> platelet  0.65426 0.45901 0.9326
#> age       1.40775 1.20377 1.6463
#> 
plot(sfg)
...
#> [1,] 0.2692571 0.22758051 0.1723655 0.4206143
#> [2,] 0.4344109 0.07477339 0.3751919 0.5029768
```
