...
#> (Intercept)   2.7657 0.05104  2.6657  2.8658 0.0000000
#> platelet     -0.3004 0.11176 -0.5194 -0.0813 0.0072009
#> tcell        -0.1455 0.14446 -0.4286  0.1377 0.3139110
#> age           0.2015 0.04824  0.1069  0.2960 0.0000296
estimate(rmtl301)
#>             Estimate Std.Err    2.5%      97.5%    P-value
#> (Intercept)   2.4449 0.07291  2.3020  2.5878257 1.618e-246
#> platelet     -0.4519 0.16739 -0.7800 -0.1238266  6.940e-03
#> tcell        -0.4937 0.25146 -0.9866 -0.0008616  4.960e-02
#> age           0.2747 0.06538  0.1466  0.4028544  2.648e-05
estimate(rmtl302)
#>             Estimate Std.Err    2.5%  97.5%   P-value
...
#> platelet    -0.402873  0.323413 -1.036750  0.231004  0.2129
#> tcell       -0.845353  0.419214 -1.666998 -0.023709  0.0437
#> age          0.214458  0.168387 -0.115575  0.544490  0.2028
#> 
#> exp(coeffients):
#>             Estimate    2.5%  97.5%
#> (Intercept)  2.64623 1.86740 3.7499
#> platelet     0.66840 0.35461 1.2599
#> tcell        0.42941 0.18881 0.9766
#> age          1.23919 0.89085 1.7237
#> 
#> 
...
pp
#>        pred        se     lower     upper
#> 1 0.4848461 0.1092227 0.2707696 0.6989227
...
#> coeffients:
#>               Estimate    Std.Err       2.5%      97.5% P-value
#> (Intercept)  0.7239522  0.0355963  0.6541847  0.7937196  0.0000
#> platelet    -0.0889613  0.0730426 -0.2321222  0.0541995  0.2232
#> tcell       -0.1951693  0.1005726 -0.3922880  0.0019493  0.0523
#> age          0.0452921  0.0358278 -0.0249290  0.1155132  0.2062
#> 
#> 
#> 
...
pp
#>        pred        se     lower     upper
#> 1 0.4851136 0.1050914 0.2791382 0.6910889
```
